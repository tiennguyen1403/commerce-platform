...
function DropdownMenuLinkItem({
  ...
  return (
    <MenuPrimitive.LinkItem
      ...
      data-inset={inset}
      className={cn(
        "group/dropdown-menu-item text-foreground focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm no-underline outline-hidden select-none focus:no-underline data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
